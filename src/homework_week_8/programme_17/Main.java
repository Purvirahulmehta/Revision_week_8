package homework_week_8.programme_17;
/*
...
public class Main {
    public static void main(String[] args) {
        Carpet carpet = new Carpet(3.5);
        Floor floor = new Floor(2.75, 4.0);
        Calculater calculater = new Calculater(floor, carpet);
        System.out.println("Total = " + calculater.getTotalCost());
        carpet = new Carpet(1.5);
        floor = new Floor(5.4, 4.5);
        calculater = new Calculater(floor, carpet);
        System.out.println("Total = " + calculater.getTotalCost());
    }
}
